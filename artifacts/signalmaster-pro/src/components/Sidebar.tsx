...
import {
  ...
  Menu, X, ChevronDown, ChevronRight, Brain, RadioTower, ChevronDown as ChevDown, Crown, Sparkles, LibraryBig, Bot
} from "lucide-react";
  ...
  const groups = [
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/dashboard/analyst", label: "Analista IA", icon: Bot },
      ]
    },
    {
      title: "Aprendizado",
